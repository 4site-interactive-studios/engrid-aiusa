...
document.onreadystatechange = () => {
  if (document.readyState === "interactive" || document.readyState === "complete") {
    ...
    const menuBtn = document.querySelector('a[role="menuitem"]'); // @TODO Make this a passive event listener to improce scrolling performance: https://web.dev/uses-passive-event-listeners/?utm_source=lighthouse&utm_medium=unknown
